...
`NOTES.md` is a scratchpad for the user's preferences and the agent's working notes. It is not a student journal and not a dialogue transcript.
...
- {preference or working observation}
```
